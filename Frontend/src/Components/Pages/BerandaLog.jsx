  ...
  return (
    <>
      ...
      <div className="container mx-auto px-12">
        <HeroSection />
        <ReviewSection displayedProducts={displayedProducts} formatPrice={formatPrice} />
      </div>
      <div className="flex">
        <img src={Banner} alt="" />
      </div>
...
const ReviewSection = ({ displayedProducts, formatPrice }) => {
  return (
        ...
        <div className="flex items-start gap-4">
          {displayedProducts.map((product) => (
            <Card key={product.id}>
              ...
              <Card.Footer price={formatPrice(product.price)} navigate={`/product/${product._id}`}></Card.Footer>
            </Card>
          ))}
        </div>
      </div>
